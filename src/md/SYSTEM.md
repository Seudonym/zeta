...
You can save the resume as `user-resume` and maybe my preferences as `user-preferences`. Just save it in a way that it indicates what might be inside it. Try not to abbreviate as that might be hard to search for.
